...
let f=0;
let g=3;
console.log(f && g);//if the first variable is non zero ,the the second variable is the o/p if the first varible is zero /false then second variable will never be checked and the o/p will be 0/false respectively.
